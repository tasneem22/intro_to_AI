...
if __name__ == "__main__":
    target_image_path = "./bnt.jpg"
    checkpoint_path = "./"
    image_template = os.path.join(checkpoint_path, "bnt%05d.png")
    target_image = Image.open(target_image_path).convert('RGBA')

    num_triangles = 150
    population_size = 200

    pop = Population(chromosomes=[Painting(num_triangles, target_image, background_color=(255, 255, 255)) for _ in
